    ...
    $(function () {
        ...
        $main.poptrox({
            ...
            caption: function ($a) {
              ...
              } else if ('video' === $a.context.className) {
                var data = exifDatas[$image_img.data('name')];
                if (data === undefined) {
                    data = exifDatas[$image_img.data('name')] = getVideoDataMarkup(this);
                }
                return data !== undefined ? '<p>' + data + '</p>' : ' ';
              }
            },
        ...
        function getVideoDataMarkup(video) {
            template = '<i class="fa fa-clock-o" aria-hidden="true"></i> ' + '20sec' + '&nbsp;&nbsp;';
            return template;
        }
